...
echo -e  "Tools    : Cyber_indonesia_security $white         " |lolcat
echo -e  "Creadby  :./King_Of414s $white   " |lolcat
echo -e  "Contact  : Cyber_indonesia_security@gmail.com $white " |lolcat
echo -e "_____________________________________________________________"
...
6) echo "created by : Cyber_indonesia_security" | lolcat
exit
;;
